...
@XmlRootElement(name = "addWorklistEntry", namespace = "http://edu.wustl.xipHost.worklist/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addWorklistEntry", namespace = "http://edu.wustl.xipHost.worklist/")
public class AddWorklistEntry {
