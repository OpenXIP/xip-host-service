...
@XmlRootElement(name = "modifyWorklistEntry", namespace = "http://edu.wustl.xipHost.worklist/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "modifyWorklistEntry", namespace = "http://edu.wustl.xipHost.worklist/")
public class ModifyWorklistEntry {
